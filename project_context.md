...
### Как работает
1. Критерии: аккаунт, маркетплейс, период, «кликов от», «расход от $»,
   «заказов не больше». По умолчанию — 30 дней, ≥10 кликов, 0 заказов.
2. Таблица найденных ASIN с чекбоксами: показы, клики, расход, продажи, заказы
   и **число активных групп**. ASIN без активных групп в выборку не попадают.

...
где профилей много: на установке margoads 14 профилей × 4 типа = 56 отчётов
разом, и Amazon начинает ограничивать частоту. В расписании margoads стоит
`--batch 1`.
...
6. **Много профилей** — `auto_collect.py --batch 1`: иначе 56 отчётов
   заказываются разом и Amazon начинает ограничивать частоту.

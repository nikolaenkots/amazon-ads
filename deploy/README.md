...
под `~/margoads`): синхронизация структуры в 10:00 и сбор статистики в 11:00 по
Варшаве (`CRON_TZ=Europe/Warsaw`, поэтому переход на зимнее время ничего не
сдвигает). Отправка изменений в Amazon по расписанию не идёт — только вручную
